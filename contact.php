...
<body>
    ...
    <section class="contact-section" style="background-color:#f3f2f2">
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
    
                <!-- google map link will be here -->
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn" name="submit" onclick="return confirm('Do You want to send data');">Send</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>108/A Rajarampuri</h3>
                                <p>Kohlapur, Pin 416 008</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>+91 7709 5615 16</h3>
                                <h3>+91 7709 5017 04</h3>
